    ...
    <main className="anexo-site">
      ...
      <div id="conteudo">
        <section className="manifest" id="conceito" aria-labelledby="manifest-title">
          <div className="manifest-number" data-reveal="scale" data-reveal-duration="long" aria-hidden="true"><span>7</span><i>dias · novos mundos ·</i></div>
        ...
        <section className="studio-entry" aria-labelledby="entry-title">
          <div className="entry-copy">
            ...
            <dl data-reveal="fade-up" data-reveal-delay="3"><div><dt>Formato</dt><dd>Foto + Vídeo</dd></div><div><dt>Ciclo</dt><dd>07 dias</dd></div><div><dt>Estado</dt><dd>Em transformação</dd></div></dl>
          </div>
          <div className="entry-media" data-reveal="media" data-reveal-duration="long">
